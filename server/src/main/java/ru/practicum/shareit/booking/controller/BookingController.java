...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<OutwardBookingDto> addBooking(@RequestBody InwardBookingDto inwardBookingDto,
    ...
    public ResponseEntity<OutwardBookingDto> approveBooking(@RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    public ResponseEntity<OutwardBookingDto> getBooking(@RequestHeader("X-Sharer-User-Id") Long userId,
                                                        @PathVariable Long bookingId) {
    ...
    public ResponseEntity<List<OutwardBookingDto>> getUserBookings(
        ...
        log.info("List<OutwardBookingDto> found user bookings: {}", found.toString());
        return new ResponseEntity<>(found, HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<OutwardBookingDto>> getOwnerBookings(
        ...
        log.info("List<OutwardBookingDto> found owner bookings: {}", found.toString());
        return new ResponseEntity<>(found, HttpStatus.OK);
    }
}
